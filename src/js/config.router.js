      ...
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              //BELLO       
               .state('app.bello', {
                  url: '/bello',
                  templateUrl: 'tpl/bello.html'
              })
               .state('app.form.bellonew', {
                  url: '/bello-new',
                  templateUrl: 'tpl/bello_new.html'
              })
               .state('app.form.belloexisting', {
                  url: '/bello-existing',
                  templateUrl: 'tpl/bello_existing.html',
                  controller: 'XeditableCtrl',
                  resolve: load(['xeditable','js/controllers/xeditable.js'])
              })  
               .state('app.form.belloinsights', {
                  url: '/bello-insights',
                  templateUrl: 'tpl/bello_insights.html',
                  resolve: load(['js/controllers/chart.js'])
              })
              // BILLING
               .state('app.billing', {
                  url: '/billing',
                  templateUrl: 'tpl/billing.html'
              })
               //INSIGHTS               
               .state('app.form.insights', {
                  url: '/insights',
                  templateUrl: 'tpl/insights.html',
                  resolve: load(['js/controllers/chart.js', 'js/controllers/vectormap.js'])
              })
              // PEOPLE
               .state('app.people', {
                  url: '/people',
              ...
              // PEOPLE INDIVIDUAL
               .state('app.individual', {
                  url: '/individual',
                  templateUrl: 'tpl/people_individual.html'
              })
              //SHIELD
               .state('app.shield', {
                  url: '/shield',
                  templateUrl: 'tpl/shield.html',
                  resolve: load(['js/controllers/chart.js', 'js/controllers/vectormap.js'])
              }) 
              .state('app', {
                  abstract: true,
